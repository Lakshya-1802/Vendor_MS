...
const EditVendor = () => {
  ...
  const location = useLocation();
    ...
    const [vid, setVid] = useState(vendor?.vid);
    ...
    const handleSubmit = async (event) => {
      ...
      try {
        const resp = await axios.patch(`${url}/vendor/update-vendor/${vid}`, formData); // Pass formData to the API endpoint
    ...
    return (
      <div className="bg-[#EEEEEE] p-5 mt-5 mx-5 md:mx-20 rounded-md drop-shadow-md borders">
        <div className="mx-3 mb-3 text-center font-bold text-2xl">Edit Vendor</div>
        <form
